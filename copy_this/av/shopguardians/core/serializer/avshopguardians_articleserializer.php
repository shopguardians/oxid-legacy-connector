<?php
/**
 * Class avshopguardiansarticleserializer
 *
 * @author Alex Schwarz <alex.schwarz@active-value.de>
 * @copyright 2020 active value GmbH
 *
 */
class avshopguardians_articleserializer
{
    /**
     ...
     * @return array
     */
    public static function transform(oxArticle $article)
    {
        return [
     ...
     * @return array
     */
    public static function getPersParams($sPersParam)
    {
        if (empty($sPersParam)) {
            return [];
        }
